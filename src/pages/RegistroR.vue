    ...
    <div class="row justify-center">
       ...
       <div class="form2"> 
        ...
        <q-form action class="form"> 
            ...
            <q-input filled color="yellow" v-model="ph" label="QuicklookID" required placeholder="EJ123456" :dense="dense" />
            ...
            <q-input class="form-label" type="email" filled color="yellow" v-model="ph2" label="Correo" required placeholder="EJ123456@ncr.com" :dense="dense2"/>
            ...
            <q-input class="form-label" type="password" filled color="yellow" v-model="ph3" label="Contraseña" required placeholder="contraseña" :dense="dense3"/>


            <!-- <q-item-label class="form-label" for="#password">Repita la contraseña:</q-item-label>
            <q-input type="password" id="password" color="yellow" placeholder="Contraseña"/> -->

            <q-input class="form-label" type="password" filled color="yellow" v-model="ph4" label="Repetir contraseña" required placeholder="contraseña" :dense="dense4"/>
